...
ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE = 'delay_param_update'
ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE_DEFAULT = False
...
ZERO_OPTIMIZATION_DEFAULT = {
    ...
    ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE: ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE_DEFAULT
}
