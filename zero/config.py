...
class DeepSpeedZeroConfig(object):
    ...
    def _initialize(self, zero_config_dict):
        ...
        self.delay_param_update = get_scalar_param(zero_config_dict,
            ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE,
            ZERO_OPTIMIZATION_DELAY_PARAM_UPDATE_DEFAULT)
