...
##################################################################3
    ...
    def zero_delay_param_update(self):
        return self._config.zero_config.delay_param_update
    ...
    def _configure_zero_optimizer(self, optimizer):
        ...
        if zero_stage == ZERO_OPTIMIZATION_OPTIMIZER_STATES:
            ...
            optimizer = FP16_DeepSpeedZeroOptimizer(
                ...
                delay_param_update=self.zero_delay_param_update(),
                mpu=self.mpu,
    ...
    def forward(self, *inputs, **kwargs):
        ...
        if self.zero_delay_param_update():
            cpu_computation_stream = torch.cuda.Stream()
            with torch.cuda.stream(cpu_computation_stream):
                self.optimizer.step_with_param_delay()
